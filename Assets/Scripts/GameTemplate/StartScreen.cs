...
namespace DefaultNamespace {
    public class StartScreen : MonoBehaviour {
        ...
        public RandomDrawer rightRandomDrawer;
        ...
        public void initGameScene() {
            ...
            rightRandomDrawer.randomResultProfiles[0].percentage = 0.5f;
            rightRandomDrawer.randomResultProfiles[1].percentage = 0.5f;
            rightRandomDrawer.update();
        }
    }
}